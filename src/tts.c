...
{
	int         ret                  = MSP_SUCCESS;
	const char* login_params         = "appid = 585b756e, work_dir = .";//登录参数,appid与msc库绑定,请勿随意改动
	
	const char* session_begin_params = "voice_name = xiaoyan, text_encoding = utf8, sample_rate = 16000, speed = 60, volume = 50, pitch = 50, rdn = 2";
